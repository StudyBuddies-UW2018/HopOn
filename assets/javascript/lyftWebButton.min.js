...
! function (n) {
    ...
    t.arrayToObject = function (n, t) {
        for (var e = t && t.plainObjects ? Object.create(null) : {}, o = 0; o < n.length; ++o) void 0 !== n[o] && (e[o] = n[o]);
        return e
    }, t.merge = function (n, e, r) {
        if (!e) return n;
        if ("object" !== (void 0 === e ? "undefined" : o(e))) {
            if (Array.isArray(n)) n.push(e);
            else {
                if ("object" !== (void 0 === n ? "undefined" : o(n))) return [n, e];
                (r.plainObjects || r.allowPrototypes || !i.call(Object.prototype, e)) && (n[e] = !0)
            }
            return n
        }
        if ("object" !== (void 0 === n ? "undefined" : o(n))) return [n].concat(e);
        var a = n;
        return Array.isArray(n) && !Array.isArray(e) && (a = t.arrayToObject(n, r)), Array.isArray(n) && Array.isArray(e) ? (e.forEach(function (e, a) {
            i.call(n, a) ? n[a] && "object" === o(n[a]) ? n[a] = t.merge(n[a], e, r) : n.push(e) : n[a] = e
        }), n) : Object.keys(e).reduce(function (n, o) {
            var i = e[o];
            return Object.prototype.hasOwnProperty.call(n, o) ? n[o] = t.merge(n[o], i, r) : n[o] = i, n
        }, a)
    }, t.decode = function (n) {
        try {
        ...
        for (var t = "string" == typeof n ? n : String(n), e = "", o = 0; o < t.length; ++o) {
            var i = t.charCodeAt(o);
            45 === i || 46 === i || 95 === i || 126 === i || i >= 48 && i <= 57 || i >= 65 && i <= 90 || i >= 97 && i <= 122 ? e += t.charAt(o) : i < 128 ? e += r[i] : i < 2048 ? e += r[192 | i >> 6] + r[128 | 63 & i] : i < 55296 || i >= 57344 ? e += r[224 | i >> 12] + r[128 | i >> 6 & 63] + r[128 | 63 & i] : (o += 1, i = 65536 + ((1023 & i) << 10 | 1023 & t.charCodeAt(o)), e += r[240 | i >> 18] + r[128 | i >> 12 & 63] + r[128 | i >> 6 & 63] + r[128 | 63 & i])
        }
        return e
    }, t.compact = function (n, e) {
        if ("object" !== (void 0 === n ? "undefined" : o(n)) || null === n) return n;
        var i = e || [],
            r = i.indexOf(n);
        if (-1 !== r) return i[r];
        if (i.push(n), Array.isArray(n)) {
            for (var a = [], l = 0; l < n.length; ++l) n[l] && "object" === o(n[l]) ? a.push(t.compact(n[l], i)) : void 0 !== n[l] && a.push(n[l]);
            return a
        }
        ...
        return null !== n && void 0 !== n && !!(n.constructor && n.constructor.isBuffer && n.constructor.isBuffer(n))
    }
}, function (n, t, e) {
    "use strict";
    ...
    function r(n, t, e) {
        return t = t || {}, t.client_id = f, t.client_token = d, u.request({
            url: n,
            data: t,
            callback: e
        })
    ...
    var f, d, u = e(17),
        m = "https://www.lyft.com/api/jsonp",
        b = m + "/get_costs",
        g = m + "/get_drivers",
        y = m + "/get_etas",
        h = m + "/get_ride_types",
    ...
    function o(n, t) {
        var e = n.className.split(" "); - 1 === e.indexOf(t) && e.push(t), n.className = e.join(" ")
    }

    function i(n, t) {
        var e = n.className.split(" "),
            o = e.indexOf(t); - 1 !== o && e.splice(o, 1), n.className = e.join(" ")
    }

    function r(n, t, e) {
        for (var o = n.childNodes || [], i = 0, r = o.length; i < r; i++)
            if (o[i][t] === e) return o[i]
    }

    function a(n, t) {
        for (var e = n, o = 0, i = t.length; o < i; o++) {
            if (!e || !t[o].length) return;
            e = r(e, "." === t[o][0] ? "className" : "id", t[o].slice(1))
        }
        return e
    }
    n.exports = {
    ...
    function o(n, t) {
        for (var e = 0; e < n.length; e++) {
            ...
            if (i) {
                ...
                for (; r < o.parts.length; r++) i.parts.push(p(o.parts[r], t))
            } else {
                for (var a = [], r = 0; r < o.parts.length; r++) a.push(p(o.parts[r], t));
                m[o.id] = {
                    id: o.id,
                    refs: 1,
                    parts: a
    ...
    function i(n, t) {
        for (var e = [], o = {}, i = 0; i < n.length; i++) {
            ...
            o[a] ? o[a].parts.push(p) : e.push(o[a] = {
                id: a,
                parts: [p]
            })
        }
    ...
    function r(n, t) {
        var e = g(n.insertInto);
        if (!e) throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");
        var o = v[v.length - 1];
        if ("top" === n.insertAt) o ? o.nextSibling ? e.insertBefore(t, o.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild), v.push(t);
        else {
    ...
    function l(n) {
        ...
        return n.attrs.type = "text/css", c(t, n.attrs), r(n, t), t
    }

    function s(n) {
        var t = document.createElement("link");
        return n.attrs.type = "text/css", n.attrs.rel = "stylesheet", c(t, n.attrs), r(n, t), t
    }
    ...
    function p(n, t) {
        ...
        if (t.transform && n.css) {
            if (!(r = t.transform(n.css))) return function () {};
            n.css = r
        }
        if (t.singleton) {
            var c = h++;
            e = y || (y = l(t)), o = f.bind(null, e, c, !1), i = f.bind(null, e, c, !0)
        } else n.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (e = s(t), o = u.bind(null, e, t), i = function () {
            a(e), e.href && URL.revokeObjectURL(e.href)
        }) : (e = l(t), o = d.bind(null, e), i = function () {
            a(e)
        });
        return o(n),
            function (t) {
    ...
    function o() {
        ...
        return n.innerHTML = e(8), y = n.childNodes[0], g = d.selectChildElement(y, [".price-range"]), b = d.selectChildElement(y, [".cta-eta", ".eta"]), y
    }

    function i(n, t) {
        var e = "https://lyft.com/ride?id=lyft",
            o = t.clientId,
            i = t.queryParams,
            r = t.location,
            a = r.pickup,
        ...
        if (n) {
            var s = i || {};
            s.partner = o, u.isEmpty(a) || (s.pickup = {
                latitude: a.latitude,
                longitude: a.longitude
            }), s.destination = {
                latitude: l.latitude,
                longitude: l.longitude
            }, e = e + "&" + m(s), n.onclick = function (n) {
                n.preventDefault(), u.logger(decodeURI(e)), window.open(e)
            }
        }
    }
    ...
    function a(n) {
        if (n && n.cost_estimates && n.cost_estimates.length)
            for (var t = 0, e = n.cost_estimates.length; t < e; t++)
                if ("lyft" === n.cost_estimates[t].ride_type) {
                    var o = Math.ceil(n.cost_estimates[t].estimated_cost_cents_min / 100),
                        i = Math.ceil(n.cost_estimates[t].estimated_cost_cents_max / 100);
                    !isNaN(parseFloat(o)) && isFinite(o) && o > 0 && !isNaN(parseFloat(i)) && isFinite(i) && i > 0 && g && (g.textContent = "$" + o + (o !== i ? "-" + i : ""))
                }
    }

    function l(n) {
        if (n && n.eta_estimates && n.eta_estimates.length)
            for (var t = 0, e = n.eta_estimates.length; t < e; t++)
                if ("lyft" === n.eta_estimates[t].ride_type) {
                    var o = Math.ceil(n.eta_estimates[t].eta_seconds / 60);
                    !isNaN(parseFloat(o)) && isFinite(o) && o > 0 && b && (b.textContent = ("small" !== h ? "Lyft in " : "") + o + " min")
                }
    }

    function s(n) {
        ["clientId", "clientToken", "location", "location.pickup", "parentElement", "scriptSrc"].forEach(function (t) {
            var e = n[t];
            if (t.indexOf(".") > -1) {
                var o = t.split(".");
                e = n[o[0]][o[1]]
            }
            if (!e) throw new Error("Missing or invalid options; did you provide a value for " + t + " in your options?")
        })
    }
    ...
    function c(n, t) {
        "small" !== h && f.getCosts({
            ...
            start_lng: n.longitude,
            end_lat: t.location.destination.latitude,
            end_lng: t.location.destination.longitude
        }, t.objectName + ".onGetCostsSuccess"), f.getEtas({
            lat: n.latitude,
            lng: n.longitude
        }, t.objectName + ".onGetEtasSuccess")
    }

    function p(n) {
        if (s(n), f.setClientId(n.clientId), f.setClientToken(n.clientToken), n.theme && n.theme.split) {
            var t = n.theme.split(" ");
            h = t[t.length - 1]
        }
        o(), r(n.theme), n.parentElement.insertBefore(y, n.parentElement.childNodes[0]);
        var e = n.location,
            a = n.location.pickup;
        i(y, n), u.hasLocationService() && u.isEmpty(e.pickup) ? navigator.geolocation.getCurrentPosition(function (t) {
            c({
            ...
            u.logger("Error in location promise", n)
        }) : c({
            latitude: a.latitude,
            longitude: a.longitude
        }, n)
    ...
    var o = e(2),
        ...
        a = function (n, t) {
            for (var e = {}, o = n.split(t.delimiter, t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit), r = 0; r < o.length; ++r) {
                var a, l, s = o[r],
                    c = -1 === s.indexOf("]=") ? s.indexOf("=") : s.indexOf("]=") + 1; - 1 === c ? (a = t.decoder(s), l = t.strictNullHandling ? null : "") : (a = t.decoder(s.slice(0, c)), l = t.decoder(s.slice(c + 1))), i.call(e, a) ? e[a] = [].concat(e[a]).concat(l) : e[a] = l
            }
            return e
        },
        l = function (n, t, e) {
            ...
            var o, i = n.shift();
            if ("[]" === i) o = [], o = o.concat(l(n, t, e));
            else {
                o = e.plainObjects ? Object.create(null) : {};
                var r = "[" === i.charAt(0) && "]" === i.charAt(i.length - 1) ? i.slice(1, -1) : i,
                    a = parseInt(r, 10);
                !isNaN(a) && i !== r && String(a) === r && a >= 0 && e.parseArrays && a <= e.arrayLimit ? (o = [], o[a] = l(n, t, e)) : o[r] = l(n, t, e)
            }
            return o
        },
        s = function (n, t, e) {
            if (n) {
                var o = e.allowDots ? n.replace(/\.([^.[]+)/g, "[$1]") : n,
                    ...
                    p = [];
                if (c) {
                    if (!e.plainObjects && i.call(Object.prototype, c) && !e.allowPrototypes) return;
                    p.push(c)
                }
                for (var f = 0; null !== (s = a.exec(o)) && f < e.depth;) {
                    if (f += 1, !e.plainObjects && i.call(Object.prototype, s[1].slice(1, -1)) && !e.allowPrototypes) return;
                    p.push(s[1])
                }
                return s && p.push("[" + o.slice(s.index) + "]"), l(p, t, e)
            }
        };
    n.exports = function (n, t) {
        var e = t || {};
        if (null !== e.decoder && void 0 !== e.decoder && "function" != typeof e.decoder) throw new TypeError("Decoder has to be a function.");
        if (e.delimiter = "string" == typeof e.delimiter || o.isRegExp(e.delimiter) ? e.delimiter : r.delimiter, e.depth = "number" == typeof e.depth ? e.depth : r.depth, e.arrayLimit = "number" == typeof e.arrayLimit ? e.arrayLimit : r.arrayLimit, e.parseArrays = !1 !== e.parseArrays, e.decoder = "function" == typeof e.decoder ? e.decoder : r.decoder, e.allowDots = "boolean" == typeof e.allowDots ? e.allowDots : r.allowDots, e.plainObjects = "boolean" == typeof e.plainObjects ? e.plainObjects : r.plainObjects, e.allowPrototypes = "boolean" == typeof e.allowPrototypes ? e.allowPrototypes : r.allowPrototypes, e.parameterLimit = "number" == typeof e.parameterLimit ? e.parameterLimit : r.parameterLimit, e.strictNullHandling = "boolean" == typeof e.strictNullHandling ? e.strictNullHandling : r.strictNullHandling, "" === n || null === n || void 0 === n) return e.plainObjects ? Object.create(null) : {};
        for (var i = "string" == typeof n ? a(n, e) : n, l = e.plainObjects ? Object.create(null) : {}, c = Object.keys(i), p = 0; p < c.length; ++p) {
            var f = c[p],
                d = s(f, i[f], e);
            l = o.merge(l, d, e)
        }
    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (n) {
        ...
        c = function n(t, e, o, r, a, l, s, c, p, f, d, u) {
            var m = t;
            if ("function" == typeof s) m = s(e, m);
            else if (m instanceof Date) m = f(m);
            else if (null === m) {
                if (r) return l && !u ? l(e) : e;
                m = ""
            }
            if ("string" == typeof m || "number" == typeof m || "boolean" == typeof m || i.isBuffer(m)) {
                if (l) {
                    return [d(u ? e : l(e)) + "=" + d(l(m))]
                }
            ...
            for (var h = 0; h < g.length; ++h) {
                var v = g[h];
                a && null === m[v] || (b = Array.isArray(m) ? b.concat(n(m[v], o(e, v), o, r, a, l, s, c, p, f, d, u)) : b.concat(n(m[v], e + (p ? "." + v : "[" + v + "]"), o, r, a, l, s, c, p, f, d, u)))
            }
            return b
        };
    n.exports = function (n, t) {
        ...
        var l = void 0 === i.delimiter ? s.delimiter : i.delimiter,
            p = "boolean" == typeof i.strictNullHandling ? i.strictNullHandling : s.strictNullHandling,
            f = "boolean" == typeof i.skipNulls ? i.skipNulls : s.skipNulls,
            d = "boolean" == typeof i.encode ? i.encode : s.encode,
            u = "function" == typeof i.encoder ? i.encoder : s.encoder,
            m = "function" == typeof i.sort ? i.sort : null,
            b = void 0 !== i.allowDots && i.allowDots,
            g = "function" == typeof i.serializeDate ? i.serializeDate : s.serializeDate,
            y = "boolean" == typeof i.encodeValuesOnly ? i.encodeValuesOnly : s.encodeValuesOnly;
        if (void 0 === i.format) i.format = r.default;
        else if (!Object.prototype.hasOwnProperty.call(r.formatters, i.format)) throw new TypeError("Unknown format option provided.");
        var h, v, w = r.formatters[i.format];
        "function" == typeof i.filter ? (v = i.filter, e = v("", e)) : Array.isArray(i.filter) && (v = i.filter, h = v);
        var x = [];
        if ("object" !== (void 0 === e ? "undefined" : o(e)) || null === e) return "";
        var F;
        F = i.arrayFormat in a ? i.arrayFormat : "indices" in i ? i.indices ? "indices" : "repeat" : "indices";
        var k = a[F];
        h || (h = Object.keys(e)), m && h.sort(m);
        for (var C = 0; C < h.length; ++C) {
            var L = h[C];
            f && null === e[L] || (x = x.concat(c(e[L], L, k, p, f, d ? u : null, v, m, b, g, w, y)))
        }
        return x.join(l)
    }
}, function (n, t, e) {
    ...
    function o(n) {
        ...
        if ("object" !== (void 0 === n ? "undefined" : l(n))) return !0;
        for (var t in n)
            if (s.call(n, t)) return !1;
        return !0
    }
    ...
    n.exports = {
        ...
        isProd: i,
        logger: r,
        hasLocationService: a
    }
}, function (n, t, e) {
    "use strict";

    function o(n) {
        if (void 0 === n || void 0 === n.src) throw new TypeError("injectScript missing one of: options, options.src");
        var t = document.getElementsByTagName("head")[0] || document.documentElement,
            e = document.createElement("script");
        e.src = n.src, e.async = n.async || !1, e.defer = n.defer || !1;
        var o = !1;
        e.onload = e.onreadystatechange = function (i) {
            if (!(o || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState)) {
                o = !0;
                var r = "[object Function]" === Object.prototype.toString.call(n.callback) ? n.callback(i) : void 0;
                return e.onload = e.onreadystatechange = null, t && e.parentNode && t.removeChild(e), r
            }
    ...
    function i(n, t) {
        ...
        for (var o in n)
            if (n.hasOwnProperty(o)) {
                var r = t ? t + "[" + o + "]" : o,
                    l = n[o];
                e.push("object" === (void 0 === l ? "undefined" : a(l)) ? i(l, r) : encodeURIComponent(r) + "=" + encodeURIComponent(l))
            } return e.join("&")
    }

    function r(n) {
        if (void 0 === n || void 0 === n.url) throw new TypeError("request missing one of: options, options.url");
        return o({
            src: n.url + (-1 !== n.url.indexOf("?") ? "&" : "?") + "callback=" + n.callback + "&" + i(n.data)
        })
    }
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (n) {
        return typeof n
    } : function (n) {
        return n && "function" == typeof Symbol && n.constructor === Symbol && n !== Symbol.prototype ? "symbol" : typeof n
    };
